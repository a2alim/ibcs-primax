...
export class PmWorkPlanService {

  private END_POINT = `${environment.ibcs.ppsProjectManagementBackendPoint}work-plan`;
  ...
  getWorkPlanByDppTappUuid(dppTappMasterUuid): Observable<any> {
    return this.http.get(this.GET_WORK_PLAN_LIST + '/' + dppTappMasterUuid).pipe(map((res: any) => res));
  }
