...
@Component({
  selector: 'app-pfs-report',
  templateUrl: './pfs-report.component.html',
  styleUrls: ['./pfs-report.component.scss']
})
export class PfsReportComponent implements OnInit {
  ...
  getPfsReportData() {
    this._reportDataService.getPfsReportData('ssss').subscribe(
      res => {
