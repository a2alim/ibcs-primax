...
import {
    ChartOptions
} from "../../../../dpp-tapp-management/features/dpp-tapp-list/dashboard/dpp-tapp-view-dashboard-beta/dpp-tapp-view-dashboard-beta.component";
...
@Component({
    selector: 'app-project-concept-edit-dashboard-beta',
    templateUrl: './project-concept-edit-dashboard-beta.component.html',
    styleUrls: ['./project-concept-edit-dashboard-beta.component.scss']
})
export class ProjectConceptEditDashboardBetaComponent implements OnInit {
    ...
    getCurrentStage() {
        this.projectMovementService.getCurrentStageForProjectConcept(this.pcMasterId).subscribe(res => {
            ...
            console.log(res);
            this.currentStage = res.res.currentStage;
    ...
    loadMovementStatus() {
        ...
        this.feedbackMovementService.getFeedbackById(srcUserGroup, pc_uuid, null, null, null).subscribe(res => {
            console.log(res);
