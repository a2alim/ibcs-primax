...
@Component({
    selector: 'app-project-concept-view-dashboard',
    templateUrl: './project-concept-view-dashboard.component.html',
    styleUrls: ['./project-concept-view-dashboard.component.scss']
})

export class ProjectConceptViewDashboardComponent implements OnInit {
    ...
    showComments(commission: 'A' | 'MD' | 'PC') {
        ...
        dialogConfig.data = {sourceId: this.projectSummary.id, source: CommentSourceEnum.PROJECT_SUMMARY, commission: commission, userGroup: this.userGroup.groupStatus};
        ;
