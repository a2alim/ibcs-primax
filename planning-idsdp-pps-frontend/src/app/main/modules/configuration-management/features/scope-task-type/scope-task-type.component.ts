...
import {ScopeTaskTypeService} from '../../services/scope-task-type.service';
...
@Component({
    selector: 'app-scope-task-type',
    templateUrl: './scope-task-type.component.html',
    styleUrls: ['./scope-task-type.component.scss']
})
export class ScopeTaskTypeComponent extends UnsubscribeAdapterComponent implements OnInit {

    formGroup: FormGroup;
    displayedColumns: string[] = ['sl', 'nameEn', 'nameBn', 'status', 'action'];

    dataSource: MatTableDataSource<ScopeTaskType>;
    total: number;
    ...
    constructor(private _fuseTranslationLoaderService: FuseTranslationLoaderService,
                private service: ScopeTaskTypeService, private dialog: MatDialog,
    ...
    // for get ScopeTaskTypeList
    private getScopeTaskTypeList() {
        this.subscribe$.add(
    ...
    // delete ScopeTaskType
    delete(row: ScopeTaskType) {
        this.subscribe$.add(
    ...
    private openDialog(row: ScopeTaskType) {
