...
@Component({
    selector: 'app-ministry-division',
    templateUrl: './ministry-division.component.html',
    styleUrls: ['./ministry-division.component.scss']
})


export class MinistryDivisionComponent extends UnsubscribeAdapterComponent implements OnInit {

    form: FormGroup;
    displayedColumns: string[] = ['sl', 'nameEn', 'nameBn', 'entryCode', 'status', 'action'];
    dataSource: MatTableDataSource<IMinistryDivision>;
    total: number;
    ...
    constructor(private _fuseTranslationLoaderService: FuseTranslationLoaderService,
                private service: MinistryDivisionService,
    ...
    // Getting all Ministry Division list
    getMinistryDivision() {
        this.subscribe$.add(
    ...
    // For creating  Ministry Division
    private create() {
        this.subscribe$.add(
    ...
    // For updating  Ministry Division
    private update() {
        this.subscribe$.add(
    ...
    // For deleting Ministry Division
    delete(row: IMinistryDivision) {
        this.subscribe$.add(
    ...
    private openDialog(type: 's' | 'u' | 'd', row?: IMinistryDivision) {
