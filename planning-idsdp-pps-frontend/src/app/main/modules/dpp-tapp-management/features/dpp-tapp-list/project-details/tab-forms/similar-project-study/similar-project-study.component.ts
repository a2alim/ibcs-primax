...
import {
    DppAnnualPhasingCostTabDetailsService
} from '../../../../../services/dpp-annual-phasing-cost-tab-details.service';
...
export class SimilarProjectStudyComponent implements OnInit {
    ...
    loadFormValue() {
        this.formGroup = this._formBuilder.group({
            ...
            similarOngoingProjectsName: ['', Validators.required],
            similarCompletedProjectsName: ['', Validators.required],
        })
    }
    ...
    save() {
        ...
        this.similarProjectStudy.similarCompletedProjectsName = this.formGroup.value.similarCompletedProjectsName;
        this.similarProjectStudy.similarOngoingProjectsName = this.formGroup.value.similarOngoingProjectsName;
    ...
    getMajorItem() {
        ...
        this.dppAnnualPhasingCostTabDetailsService.getByProjectConceptIdAndIsMajor(this.projectConceptMasterId, true, true).subscribe((response) => {
            let res = response;
            ...
            for (let i = 0; i < res.length; i++) {
                ...
                if(res[i].isBasis == true){
                    const row = this._formBuilder.group({
                        ...
                        majorItem: res[i].subEconomicCodeDTO.subEconomicCode,
                ...
                if (res.itemWiseCostEstimatedList != null) {
                    if (res.itemWiseCostEstimatedList.length > 0) {
                        res.itemWiseCostEstimatedList.forEach(re => {
                            ...
                            const row = this._formBuilder.group({
                                majorItem: re.majorItem != null ? re.majorItem : '',
                                description: re.description != null ? re.description : '',
                                unit: re.unit != null ? re.unit : '',
                                unitTypeName: re.unitType.unitTypeNameEng != null ? re.unitType.unitTypeNameEng : '',
                                unitCost: re.unitCost != null ? re.unitCost.toFixed(2) : '',
                                basis: re.basis != null ? re.basis : '',
                                source: re.source != null ? re.source : '',
                                itemWiseCostDate: re.itemWiseCostDate != null ? re.itemWiseCostDate : '',
                    ...
                    if (res.costOfMajorItemList.length > 0) {
                        res.costOfMajorItemList.forEach(re => {
                            const row = this._formBuilder.group({
                                ...
                                unit: re.unit != null ? re.unit : '',
                                unitTypeName: re.unitType.unitTypeNameEng != null ? re.unitType.unitTypeNameEng : '',
                                proposalProject: re.proposalProject != null ? re.proposalProject.toFixed(2) : '',
                                similarGoingProject: re.similarGoingProject != null ? re.similarGoingProject : '',
                                similarCompleteProject: re.similarCompleteProject != null ? re.similarCompleteProject : '',
                                remarks: re.remarks != null ? re.remarks : '',
    ...
    setSimilarProject(res: any) {
        this.formGroup.patchValue({
            ...
            similarOngoingProjectsName: res.similarOngoingProjectsName,
            similarCompletedProjectsName: res.similarCompletedProjectsName,
        });
    }
