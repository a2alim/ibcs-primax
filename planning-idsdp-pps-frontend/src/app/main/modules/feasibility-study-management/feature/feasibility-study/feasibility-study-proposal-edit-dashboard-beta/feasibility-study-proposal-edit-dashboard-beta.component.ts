...
} from '../../../../feasibility-study-management/feature/feasibility-study/feasibility-study-proposal-edit-dashboard/i18n/en';
import {
    locale as lngBangla
} from '../../../../feasibility-study-management/feature/feasibility-study/feasibility-study-proposal-edit-dashboard/i18n/bn';
import {
    ERROR,
    OK,
...
@Component({
    selector: 'app-feasibility-study-proposal-edit-dashboard-beta',
    templateUrl: './feasibility-study-proposal-edit-dashboard-beta.component.html',
    styleUrls: ['./feasibility-study-proposal-edit-dashboard-beta.component.scss']
})
export class FeasibilityStudyProposalEditDashboardBetaComponent implements OnInit {
    ...
    sendProjectConceptToNothi() {
        console.log('nothi');
        this.enothiDakSubmissionService.submitDak('feasability study').subscribe(res => {
            console.log(res)
            if (res) {
