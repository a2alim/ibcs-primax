...
export class TappQualificationSupportStuffService{
    ...
    createSupportStuff(staffModel: any,  tappSupportStuffs: any): Observable<any>{
        ...
        const url: string = environment.ibcs.ppsRdppRtappBackendPoint + 'qualificationSupportStuff/create234';
    ...
    update(staffModel: any,  tappSupportStuffs: any, pcUuid: any): Observable<any>{
        ...
        const url: string = environment.ibcs.ppsRdppRtappBackendPoint + 'qualificationSupportStuff/updateSupportStuff' + '/' + pcUuid;
    ...
    getSupportStuff(pcUuid: string){
        const url: string = environment.ibcs.ppsRdppRtappBackendPoint + 'qualificationSupportStuff/getSupportStuff'+ '/' + pcUuid;
