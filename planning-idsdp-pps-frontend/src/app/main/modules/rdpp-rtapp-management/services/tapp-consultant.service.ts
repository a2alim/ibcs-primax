...
export class TappConsultantService  {
    ...
    createConsultant(consultantList: any): Observable<any> {
      ...
      const url: string = environment.ibcs.ppsRdppRtappBackendPoint + 'consultant/create';
    ...
    updateConsultant(model : any): Observable<any> {
        const url: string = environment.ibcs.ppsRdppRtappBackendPoint + 'consultant/updateConsultant';
  ...
  getTappAnnexureThree(projectConceptUuid: string){
      const url: string = environment.ibcs.ppsRdppRtappBackendPoint + 'consultant/getTappAnnexureThree' + '/' + projectConceptUuid;
    ...
    deleteRow(uuid): Observable<any> {
        ...
        const url: string = environment.ibcs.ppsRdppRtappBackendPoint + 'consultant/deleteRow' + '/' + uuid;
