...
export class TappAnnualPhasingCostService extends CrudRequestService<ITppAnnualPhasingCost> {
    ...
    public getDetailsEstimatedCostInRdpp(id: number): Observable<any> {
        return this.http.get(TappAnnualPhasingCostConstant.RTAPP_ANNUAL_PHASING_COST + DppAnnualPhasingCostConstant.GET_DETAILS_ESTIMATED_COST + '/' + id);
    }
