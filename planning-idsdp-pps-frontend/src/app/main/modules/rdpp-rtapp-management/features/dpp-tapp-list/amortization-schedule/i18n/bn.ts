export const locale = {
    ...
    data: {
        ...
        'isShow': true,
        'heading': 'সংযোজনী-৬ গৃহীত ঋণ পরিশোধ সংক্রান্ত সিডিউল',
        'subHeading': 'হোম ',
        'subHeading2': ' সংযোজনী-৬ গৃহীত ঋণ পরিশোধ সংক্রান্ত সিডিউল',
        'title': 'সংযোজনী-৪ গৃহীত ঋণ পরিশোধ সংক্রান্ত সিডিউল',
        'sub_title': 'হোম > সংযোজনী-৪ গৃহীত ঋণ পরিশোধ সংক্রান্ত সিডিউল',
