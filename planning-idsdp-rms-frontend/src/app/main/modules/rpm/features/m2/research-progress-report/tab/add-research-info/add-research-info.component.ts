...
@Component({
  selector: 'app-add-research-info',
  templateUrl: './add-research-info.component.html'
})
export class AddResearchInfoComponent implements OnInit {
 ...
 ngOnInit(): void {
     ...
     uuid:[''],
     m1ResearcherProposalInfoId :['', Validators.required],
     stFiscalYearId :['', Validators.required],
     stResearchCategoryTypeId :['', Validators.required],
     researcherUserId :['', Validators.required],
     presentationStatus :['', Validators.required],
     researchCompletedPercentage :['', Validators.required],
