...
@Component({
    selector: 'app-researcher-installment-go-form',
    templateUrl: './researcher-installment-go-form.component.html',
})
export class ResearcherInstallmentGoFormComponent implements OnInit {
    /*----Button---*/
