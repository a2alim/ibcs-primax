...
@Component({
  selector: 'app-researcher-installment-go-list',
  templateUrl: './researcher-installment-go-list.component.html',
  styleUrls: ['./researcher-installment-go-list.component.scss']
})
export class ResearcherInstallmentGoListComponent implements OnInit {
 /*----Button---*/
 editIcon = editIcon;
