...
@Component({
  selector: 'app-researcher-agreement-details',
  templateUrl: './researcher-agreement-details.component.html',
  styleUrls: ['./researcher-agreement-details.component.scss']
})
export class ResearcherAgreementDetailsComponent implements OnInit {
