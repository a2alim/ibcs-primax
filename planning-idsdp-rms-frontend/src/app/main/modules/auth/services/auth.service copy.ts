...
export class AuthService {
    ...
    tokenInfo = localStorage.getItem('access_token');
    ...
    getLoggedUserName(): string {
       // let tokenInfo = this.getDecodedAccessToken(this.cookieService.get('access_token')); // decode token
        let tokenInfo = this.getDecodedAccessToken(localStorage.getItem('access_token')); // decode token
    ...
    * */
    ...
    signOut(): Observable<any> {
        ...
        // this.cookieService.set('doptor_token', '', null, '/');

        localStorage.removeItem('access_token');
        localStorage.removeItem('sessionId');
        localStorage.removeItem('doptor_token');
