...
@RestApiController
@AllArgsConstructor
@RequestMapping("trainers-view")
public class RmsTrainresViewController {

    private final RmsTrainresViewService rmsTrainresViewService;
    ...
    public ResponseEntity<byte[]> getSeminarReport(@PathVariable Long id,@PathVariable String lang) throws IOException, ExecutionException, InterruptedException {
        CusJasperReportDef report = rmsTrainresViewService.getTrainresViewPdf(id,lang);
