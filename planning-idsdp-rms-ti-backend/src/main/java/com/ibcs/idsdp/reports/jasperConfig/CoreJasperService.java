package com.ibcs.idsdp.reports.jasperConfig;
...
//		File reportFile = ResourceUtils.getFile("src/main/resources/report/dppPartB/3_planning_dpp_part_b_bn_main.jrxml");
//		JasperReport report = JasperCompileManager.compileReport(reportFile.getAbsolutePath());
//		JRSaver.saveObject(report, "src/main/resources/report/dppPartB/3_planning_dpp_part_b_bn_main.jasper");
//		
//
//		File sub1reportFile = ResourceUtils.getFile("src/main/resources/report/dppPartB/3_planning_dpp_part_b_bn_sub_15_proj_desc.jrxml");
//		JasperReport sub1report = JasperCompileManager.compileReport(sub1reportFile.getAbsolutePath());
//		JRSaver.saveObject(sub1report, "src/main/resources/report/dppPartB/3_planning_dpp_part_b_bn_sub_15_proj_desc.jasper");
//		
//		
//		File sub2reportFile = ResourceUtils.getFile("src/main/resources/report/dppPartB/3_planning_dpp_part_b_bn_sub_prob_bckg.jrxml");
//		JasperReport sub2report = JasperCompileManager.compileReport(sub2reportFile.getAbsolutePath());
//		JRSaver.saveObject(sub2report, "src/main/resources/report/dppPartB/3_planning_dpp_part_b_bn_sub_prob_bckg.jasper");
		
		
//		jasperPrint = JasperFillManager.fillReport(report, reportDef.getParameters(),
//				jrDataSource);
