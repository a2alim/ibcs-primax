package com.ibcs.idsdp.feasibilitystudy.approval_process_flow.web.controller;


import com.ibcs.idsdp.common.web.dto.response.ResponseWithResults;
import com.ibcs.idsdp.config.annotations.RestApiController;
import com.ibcs.idsdp.feasibilitystudy.approval_process_flow.constants.ProjectMovementStageConstants;
...
public class ProjectMovementController {
    ...
    @GetMapping(ProjectMovementStageConstants.GET_CURRENT_STAGE_IN_FS+"/{id}")
    public ResponseWithResults getCurrentProjectStageInFs(@PathVariable("id") Long id){
        ProjectMovementStage projectMovementStage =  projectMovementService.getCurrentStageInFsProposal(id);
        return new ResponseWithResults(200,"Data Found", projectMovementStage);
    }
}
