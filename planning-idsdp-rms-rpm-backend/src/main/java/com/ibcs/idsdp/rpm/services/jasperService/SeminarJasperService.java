 ...
 */
public interface SeminarJasperService {
    CusJasperReportDef getSeminarPdf(Long id,String lang,Long viewNumber) throws ExecutionException, InterruptedException;
}
